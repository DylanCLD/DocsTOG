    ...
    <div className="space-y-6">
      ...
      {canWrite(profile.role) && (
        <form action={createPage} className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4">
          <div className="grid gap-3 md:grid-cols-[5rem_1fr_14rem_auto] md:items-end">
            <div>
            ...
            <div>
              ...
              <Input id="category" name="category" defaultValue="Général" />
            </div>
            <Button type="submit">
      ...
      {pages.length === 0 ? (
        <EmptyState icon={StickyNote} title="Aucune page créée" description="Commence par créer une page pour documenter une idée, une décision ou un système." />
      ) : (
              ...
              <Card className="h-full p-4 transition hover:-translate-y-0.5 hover:bg-[var(--surface-elevated)]">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-4 text-xs text-[var(--muted)]">Modifiée {formatDateTime(page.updated_at)}</p>
                  </div>
                </div>
              </Card>
            </Link>
